...
public class TestConstants {
    public static final Function1<Object, Integer> hashCode = new Function1<Object, Integer>() {
        @Override
    ...
    public static final Function1<Integer, Integer> plus2 = new Function1<Integer, Integer>() {
        @Override
    ...
    public static final Function1<Integer, Integer> mul3 = new Function1<Integer, Integer>() {
        @Override
        public Integer apply(Integer arg) {
            return arg * 3;
        }
    ...
    public static final Predicate<Object> isHashCodeEven = new Predicate<Object>() {
        @Override
