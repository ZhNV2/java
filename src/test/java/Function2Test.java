...
public class Function2Test {
    ...
    public void testCompose() {
        ...
        Function2<Integer, Integer, Integer> comp = TestConstants.SUM.compose(TestConstants.MUL_3);
        assertEquals(comp.apply(3, 4), Integer.valueOf(21));
        assertEquals(comp.apply(0, -1), Integer.valueOf(-3));

        Function2<String, String, Integer> comp2 = TestConstants.CONCAT.compose(TestConstants.HASH_CODE);
        String a = "Kolya";
        String b = "Olya";
