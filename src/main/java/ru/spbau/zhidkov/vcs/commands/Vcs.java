...
import ru.spbau.zhidkov.vcs.handlers.*;
...
public class Vcs {
    ...
    public String status() throws IOException, VcsIncorrectUsageException {
        ...
        String status = "";
        status = status + ("Modified files:") + (System.lineSeparator());
        status = status + (listToPrint(statusHolder.modifiedFiles));
        status = status + ("Added files:") + (System.lineSeparator());
        status = status + (listToPrint(statusHolder.addedFiles));
        status = status + ("Removed files:") + (System.lineSeparator());
        status = status + (listToPrint(statusHolder.removedFiles));
        status = status + ("Foreign files:") + (System.lineSeparator());
        status = status + (listToPrint(statusHolder.foreignFiles));
        return status;
    }
    ...
    private String listToPrint(List<Path> list) {
        String listToPrint = "";
        for (Path s : list) {
            listToPrint = listToPrint + s + System.lineSeparator();
        }
        return listToPrint;
    }
